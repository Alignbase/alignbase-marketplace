...
If setup fails, confirm that the workspace admin enabled the Alignbase app for your role, then reconnect it. In Codex, also review the startup hook and start a new session.
